...
#define CUSTOM_MACHINE_NAME "Liht"
...
#define Z_SERVO_ANGLES {82,10}  // Z Servo Deploy and Stow angles
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -8.30  // Z offset: -below +above  [the nozzle]
...
#define SERVO_DELAY { 500,500,500,500 }
